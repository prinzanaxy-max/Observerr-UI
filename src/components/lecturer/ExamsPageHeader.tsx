...
const ExamsPageHeader = memo(({ initials, onGoLive, goingLive = false }: ExamsPageHeaderProps) => (
  <header className="hidden md:flex shrink-0 justify-between items-center h-16 px-8 bg-student-surface/80 backdrop-blur-md border-b border-transparent z-20">
    ...
    <div className="flex items-center gap-4">
      ...
      <button
        ...
        onClick={onGoLive}
        disabled={goingLive}
        className="px-4 py-2 rounded-full bg-student-error-container text-student-on-error-container text-student-label-md font-student font-bold hover:bg-student-error/20 transition-colors disabled:opacity-60"
      >
