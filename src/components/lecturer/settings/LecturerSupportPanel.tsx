...
import type { SupportFaqItem } from '../../../data/lecturerSettingsData';

type LecturerSupportPanelProps = {
  faq: SupportFaqItem[];
...
const LecturerSupportPanel = memo(({
  faq,
  documentationHref,
  documentationLabel = 'Documentation',
  documentationDescription = 'Observerr lecturer guides',
}: LecturerSupportPanelProps) => {
      ...
      <section className="student-exam-glass-card rounded-[24px] p-6 sm:p-8">
        <div className="mb-6">
          ...
          <p className="text-student-body-md font-student text-student-on-surface-variant">
            Contact support or browse common questions about exams, proctoring, and integrity review.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 max-w-2xl">
          ...
          {documentationHref && (
            ...
            >
              ...
              <div>
                <p className="text-student-body-lg font-student font-medium text-student-on-surface">{documentationLabel}</p>
                <p className="text-student-body-md font-student text-student-on-surface-variant">{documentationDescription}</p>
              </div>
            </a>
          )}
        </div>
...
LecturerSupportPanel.displayName = 'LecturerSupportPanel';

export default LecturerSupportPanel;
